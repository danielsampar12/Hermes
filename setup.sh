...
echo "  I travel freely where others cannot: between the living and the dead,"
echo "  between confusion and clarity, between your ideas and working code."
echo ""
echo "  I won't be staying. My job is to get you set up and step aside."
...
echo ""
info "So be it. I am $ASSISTANT_NAME."
...
# ── Role selection ────────────────────────────────────────────────────────────
echo ""
echo "  Now — choose your companion. They will fight alongside you."
echo "  Choose wisely. You can always change this later."
echo ""
echo "  1. Chiron (pair programmer)"
echo "     Son of Kronos, teacher of heroes. He trained Achilles, Jason, and Asclepius."
echo "     Chiron won't just write your code — he'll make sure you understand every"
echo "     decision. He asks before acting, shapes your thinking, and won't let you"
echo "     walk into a bad pattern without warning you first."
echo ""
echo "  2. Ares (implementer)"
echo "     God of war. Impulsive, fierce, and unstoppable in battle."
echo "     No philosophy, no hand-holding — you point, he conquers."
echo "     Give him a clear task and get battle-ready code. Fast and direct."
echo ""
